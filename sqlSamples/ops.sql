--Salesforce data mart model
SELECT
    IFNULL(account.account_id, 'MissingAccountID')      AS account_id,
    IFNULL(account.account_name, 'MissingAccountName')  AS account_nm,
    IFNULL(pilot_units.pilots, 0)                       AS active_pilot_units_nr,
    opportunity.ae_forecast_category                    AS ae_forecast_category_nm,
    ...
    opportunity.forecast_category                       AS forecast_category_nm_2,
    ...
    opportunity.manager_forecast_category               AS manager_forecast_category_nm,
